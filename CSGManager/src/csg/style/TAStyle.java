...
public class TAStyle extends AppStyleComponent {
    ...
    public static String CLASS_START_TIME_BOX = "start_time_box";
    public static String CLASS_END_TIME_BOX = "end_time_box";
    ...
    public void initOfficeHoursGridStyle() {
        ...
        workspaceComponent.getStartTimeBox().getStyleClass().add(CLASS_START_TIME_BOX);
        workspaceComponent.getEndTimeBox().getStyleClass().add(CLASS_END_TIME_BOX);
        workspaceComponent.getStartTimeLabel().getStyleClass().add(CLASS_START_TIME_LABEL);
