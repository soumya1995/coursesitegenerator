...
public class DeleteRecitation_Transaction implements jTPS_Transaction {
    ...
    public DeleteRecitation_Transaction(String initSection, String initInstructor, String initDay, String initLocation, String initTA1, String initTA2, CSGManager initApp){
        section = initSection;
